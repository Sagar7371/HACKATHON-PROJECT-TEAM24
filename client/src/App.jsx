...
const people = [
  { name: 'Maya Chen', role: 'Brand photographer', city: 'Brooklyn, NY', skills: 'Photography · Branding', wants: 'UX writing · Spanish', initials: 'MC', color: '#dbe8de', rating: 4.9, exchanges: 18, responseTime: 'Usually replies in 2h', availability: 'Weekends', format: 'In person', verified: true, lastActive: 'Active today', bio: 'I help thoughtful brands find a clear visual voice through photography and simple creative direction.', portfolioUrl: '#' },
  { name: 'Arjun Mehta', role: 'Data analyst', city: 'Austin, TX', skills: 'Python · Excel', wants: 'Photography · Public speaking', initials: 'AM', color: '#efe1c5', rating: 4.8, exchanges: 24, responseTime: 'Usually replies in 1h', availability: 'Weekdays', format: 'Online', verified: true, lastActive: 'Active 20m ago', bio: 'Data analyst who enjoys turning messy questions into useful dashboards and repeatable systems.', portfolioUrl: '#' },
  { name: 'Lina Okafor', role: 'Mindfulness coach', city: 'London, UK', skills: 'Wellbeing · Journaling', wants: 'HTML · Illustration', initials: 'LO', color: '#d9e5ed', rating: 5, exchanges: 12, responseTime: 'Usually replies in 4h', availability: 'Flexible', format: 'Video call', verified: true, lastActive: 'Active yesterday', bio: 'I create gentle, practical routines for people who want more clarity and less noise in their day.', portfolioUrl: '#' }
];
